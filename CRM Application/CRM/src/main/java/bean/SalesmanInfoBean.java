...
public class SalesmanInfoBean {
	...
	public SalesmanInfoBean(String message, String salesmanId, String salesmanFirstName, String salesmanLastName,
			...
			String salesmanScheduleDescription, DAOImple daoImple, String message2, String messageForDetetion,
			String salesmanIdToDelete) {
		super();
	...
	public String toString() {
		return "SalesmanInfoBean [message=" + message + ", salesmanId=" + salesmanId + ", salesmanFirstName="
				...
				+ scheduletype + ", salesmanScheduleDescription=" + salesmanScheduleDescription + ", daoImple="
				+ daoImple + ", message2=" + message2 + ", messageForDetetion=" + messageForDetetion
			...
			if(salesmanMobileNo.length()==10) {
			      try {
			    	  ...
			    	  Long.parseLong(salesmanMobileNo);
			    		mesg= daoImple.insertNUpdateSalesman(this); //tostring is called of current object
						if(mesg!="doNothing")
							message=mesg;
		...
		public List<SalesmanNSchedule> readSalesmans() throws SQLException{
			...
			System.out.println("inside readSalesman salesmaninfobean");
			 ...
			 slmnList=daoImple.readSalesmans();
	    ...
	    public void salesmanDelete() throws SQLException{
	    	...
	    	messageForDetetion=daoImple.salesmanDelete(salesmanIdToDelete);
