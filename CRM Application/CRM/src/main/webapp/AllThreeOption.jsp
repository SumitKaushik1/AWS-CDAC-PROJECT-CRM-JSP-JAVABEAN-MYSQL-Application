...
<title> Dashboard</title>
 ...
 <body>
   ...
   <c:set var="dashboard" value="allThreeOption"  scope="session"/>
         <%--to tell the next page that request is comming from AllOneOPtion.jsp page --%>
       <%--it is the map which var is key is holding the value  --%>
    
    
 
  <%--session.setAttribute("dashboared","admin")  ie it will makt eh map in the same session --%>
	     <%-- --%>
                                ...
                                <div class="box  /*border border-primary*/">
                                          ...
                                          <div class="container text-center">
														  <div class="row">
															...
															<div class="col-12 /*border border-secondary*/ align-self-center box1">
