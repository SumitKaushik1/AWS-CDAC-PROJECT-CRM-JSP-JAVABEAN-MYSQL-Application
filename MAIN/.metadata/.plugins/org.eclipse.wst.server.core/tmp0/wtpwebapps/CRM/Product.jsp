										   ...
										   <tbody id="body-inside">
											        ...
											        <c:forEach var="productdetails" items="${sessionScope.listOfProduct}">
											              <%--sesssion.getAttribut("listOfProduct")->return list  --%>  
											                <%-- productdetailes is key its object is returned--%>   
											            <tr>      
											                 <%--session.getAttribue("productdetails").getProdcutId() --%>                  
												            ...
												            <td>${productdetails.productDescription}</td>
												             <td><button type="button"  onclick="return confirm('delete customer details');"  class="btn btn-danger"><a href="CrudOperation3.jsp?productIdToDelete=${productdetails.productId}"  style="text-decoration: none;color: black;font-weight: bolder;" >Delete</a></button></td>
											            </tr>                                  
											         </c:forEach>   
