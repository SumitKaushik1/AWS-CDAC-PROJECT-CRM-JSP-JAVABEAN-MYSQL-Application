										       ...
										       <c:if test="${sessionScope.listOfSalesman!='null'}">
											        ...
											        <c:forEach var="salesmandetails" items="${sessionScope.listOfSalesman}">
											            ...
											            <tr>  
											                ...
											                <td><button type="button"  onclick="return confirm('delete customer details');"  class="btn btn-danger"><a href="CrudOperation3.jsp?salesmanIdToDelete=${salesmandetails.salesmanId}"  style="text-decoration: none;color: black;font-weight: bolder;" >Delete</a></button></td>
											            </tr>                                  
											         </c:forEach>   
